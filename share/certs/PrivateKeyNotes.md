...
The private keys for these certificates were generated on a main work machine,
following the certificate authoritys' recommendations for generating certificate
signing requests.

For OSX, the private key was generated by Keychain.app on a main work machine.
...
For Windows, the private key was generated by Firefox running on a main work machine.
...
The machine used to sign the binaries could be compromised, either remotely or
by breaking into the secure location, allowing the attacker to get the private key files and then
